      ...
      <main className="pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="prose prose-gray max-w-none space-y-10">
            ...
            {/* Éditeur */}
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">1. Éditeur du site</h2>
            ...
            {/* Hébergement */}
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">2. Hébergement</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">3. Propriété intellectuelle</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">4. Données personnelles</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Cookies */}
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">5. Cookies</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Responsabilité */}
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">6. Limitation de responsabilité</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Droit applicable */}
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">7. Droit applicable</h2>
              <p className="text-gray-700 leading-relaxed">
