      ...
      <main className="pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="prose prose-gray max-w-none space-y-10">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">2. Données collectées</h2>
              <p className="text-gray-700 leading-relaxed">Nous collectons les données suivantes :</p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">3. Finalités du traitement</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">4. Conservation des données</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">5. Partage des données</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">6. Vos droits</h2>
              <p className="text-gray-700 leading-relaxed">Vous disposez des droits suivants concernant vos données personnelles :</p>
              <ul className="mt-3 space-y-2 text-gray-700 list-disc pl-5">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100">7. Sécurité</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="bg-[#0D1B3E]/5 rounded-xl p-6">
              ...
              <p className="text-gray-700">Pour toute question relative à cette politique de confidentialité :</p>
