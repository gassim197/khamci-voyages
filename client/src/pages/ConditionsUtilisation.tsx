      ...
      <main className="pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="prose prose-gray max-w-none space-y-10">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">1. Acceptation des conditions</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">2. Services proposés</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">3. Tarifs et paiement</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">4. Annulation et remboursement</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">5. Responsabilités</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">6. Utilisation du site</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#0D1B3E] mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">7. Modification des conditions</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="bg-[#0D1B3E]/5 rounded-xl p-6">
              ...
              <p className="text-gray-700 dark:text-gray-300">Pour toute question relative à ces conditions d'utilisation :</p>
